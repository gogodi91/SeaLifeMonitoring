...
class Area(models.Model):
	Start_Latitude_Degrees = models.IntegerField()
	Start_Latitude_Minutes = models.IntegerField()
	Start_Latitude_Seconds = models.IntegerField()
	Start_Longitude_Degrees = models.IntegerField()
	Start_Longitude_Minutes = models.IntegerField()
	Start_Longitude_Seconds = models.IntegerField()
	End_Latitude_Degrees = models.IntegerField()
	End_Latitude_Minutes = models.IntegerField()
	End_Latitude_Seconds = models.IntegerField()
	End_Longitude_Degrees = models.IntegerField()
	End_Longitude_Minutes = models.IntegerField()
	End_Longitude_Seconds = models.IntegerField()
